...
<div class="nav-content" class:desktop class:mobile={!desktop}>
	...
	<nav aria-label="Main">
		{#if !desktop}
			<IconButton class="menu-button" icon={Menu} label="Open menu" bind:this={openMenuButton} on:click={openMenu} aria-expanded={isOpen}></IconButton>
		{/if}
		<div
		...
		>
			{#if !desktop}
			<IconButton class="close-menu-button" icon={X} label="Close menu" bind:this={closeMenuButton} on:click={closeMenu} on:keydown={moveFocusToBottom} />
